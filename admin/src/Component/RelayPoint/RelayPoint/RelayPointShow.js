...
import {
    ...
    FormTab,
    TabbedShowLayout,
    TextField, BooleanField, ReferenceField, SelectField, ReferenceArrayField, SingleFieldList, ChipField, NumberField, RichTextField, FunctionField,Tab
} from 'react-admin';
        ...
        <TabbedShowLayout>
            <Tab label="Identité">
               ...
               <SelectField source="status" label="Status" choices={statusChoices} />
                <ReferenceArrayField source="relayPointTypes" label="Types" reference="relay_point_types" allowEmpty>
                    <SingleFieldList>
