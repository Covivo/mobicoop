...
After starting the app you can use `make fixtures` this will import the databases, create private/public keys .. *DO IT 1 MN AFTER THE START, not before*
...
- Database just go to [http://localhost:8083](http://localhost:8083) for Open Phpmyadmin
