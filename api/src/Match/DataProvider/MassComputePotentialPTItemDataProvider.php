...
final class MassComputePotentialPTItemDataProvider implements ItemDataProviderInterface, RestrictedDataProviderInterface
{
    ...
    public function __construct(MassPublicTransportPotentialManager $massPublicTransportPotentialManager)
    {
        $this->massPublicTransportPotentialManager = $massPublicTransportPotentialManager;
    }

    public function supports(string $resourceClass, string $operationName = null, array $context = []): bool
    {
        return Mass::class === $resourceClass && 'computePTPotential' == $operationName;
    }
