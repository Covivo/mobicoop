...
final class Version20190701132135 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE recipient (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, message_id INT DEFAULT NULL, medium_id INT DEFAULT NULL, status SMALLINT NOT NULL, read_date DATETIME NOT NULL, INDEX IDX_6804FB49A76ED395 (user_id), INDEX IDX_6804FB49537A1329 (message_id), INDEX IDX_6804FB49E252B6A5 (medium_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
