...
final class Version20240416062459 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        // Adds notification
        $this->addSql('INSERT INTO `notification` (id, action_id, medium_id, template_title, active, template_body, created_date, updated_date, user_active_default, user_editable, `position`, alt) VALUES (175, 140, 2, NULL, 1, NULL, "2024-04-16 08:00", NULL, 1, 0, 0, NULL)');
    }
