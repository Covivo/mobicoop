 ...
 */
final class Version20200321151738 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE carpool_proof DROP ask_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE carpool_proof ADD ask_id INT NOT NULL');
