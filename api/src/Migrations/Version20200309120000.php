...
final class Version20200309120000 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO article (`id`, `title`, `status`) VALUES (4, "DATA_POLICY", 1), (5, "INSURANCE_POLICY", 1), (6, "HISTORY", 1), (7, "ACTORS", 1), (8, "SOLIDARY_CARPOOL", 1), (9, "BECOME_PARTNER", 1), (10, "FAQ", 1), (11, "TOOLBOX", 1), (12, "COMMUNITYINFOS", 1), (13, "LOM", 1), (14, "GOODPRACTICES", 1), (15, "MOREABOUT", 1)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DELETE FROM `article` WHERE `article`.`id` = 4;');
