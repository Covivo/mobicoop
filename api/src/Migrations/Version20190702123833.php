...
final class Version20190702123833 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE notified (id INT AUTO_INCREMENT NOT NULL, notification_id INT DEFAULT NULL, medium_id INT DEFAULT NULL, user_id INT DEFAULT NULL, status SMALLINT NOT NULL, sent_date DATETIME NOT NULL, received_date DATETIME NOT NULL, read_date DATETIME NOT NULL, INDEX IDX_D23269D4EF1A9D84 (notification_id), INDEX IDX_D23269D4E252B6A5 (medium_id), INDEX IDX_D23269D4A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE notification (id INT AUTO_INCREMENT NOT NULL, action_id INT DEFAULT NULL, medium_id INT DEFAULT NULL, template VARCHAR(255) NOT NULL, active TINYINT(1) DEFAULT NULL, active_default TINYINT(1) DEFAULT NULL, INDEX IDX_BF5476CA9D32F035 (action_id), INDEX IDX_BF5476CAE252B6A5 (medium_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
