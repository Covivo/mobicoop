 ...
 */
final class Version20190103155614 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE proposal DROP proposal_origin_id, DROP duration, DROP distance, CHANGE proposal_linked_id proposal_linked_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE proposal ADD proposal_origin_id INT DEFAULT NULL, ADD duration INT DEFAULT NULL, ADD distance INT DEFAULT NULL, CHANGE proposal_linked_id proposal_linked_id INT DEFAULT NULL');
