...
final class Version20200319134004 extends AbstractMigration
{
    ...
    {
        $this->addSql('INSERT INTO `action` (`id`, `name`, `position`) VALUES (33, \'carpool_ad_minor_updated\', 0);');
        $this->addSql('INSERT INTO `action` (`id`, `name`, `position`) VALUES (34, \'carpool_ad_major_updated\', 0);');
