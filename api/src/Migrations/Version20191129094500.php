 ...
 */
final class Version20191129094500 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO `action` (`id`, `name`, `in_log`, `position`) VALUES (19, \'passenger_carpool_linked_account_deleted_driver\', 1, 12);');
        ...
        $this->addSql('INSERT INTO `action` (`id`, `name`, `in_log`, `position`) VALUES (20, \'driver_carpool_linked_account_deleted_passenger\', 1, 13);');
