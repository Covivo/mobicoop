...
final class Version20241217170300 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        // désactive les notifications SMS pour les users qui ont des pushs actifs sauf carpool_ask_xxx
