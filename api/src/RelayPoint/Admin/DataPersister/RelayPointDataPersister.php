...
final class RelayPointDataPersister implements ContextAwareDataPersisterInterface
{
    ...
    {
        return $data instanceof RelayPoint && ($context['collection_operation_name'] == 'ADMIN_post' || $context['item_operation_name'] == 'ADMIN_patch' || $context['item_operation_name'] == 'ADMIN_delete');
    }
