 ...
 */
class GratuityCampaignNotificationRepository
{
    /**
    ...
    {
        $this->_repository = $entityManager->getRepository(GratuityNotification::class);
    }

    public function find(int $id): ?GratuityNotification
    {
