...
final class GratuityCampaignAsNotifiedItemDataProvider implements RestrictedDataProviderInterface, ItemDataProviderInterface
{
    ...
    {
        return GratuityCampaign::class === $resourceClass && 'tagAsNotified' === $operationName;
    }

    public function getItem(string $resourceClass, $id, string $operationName = null, array $context = [])
    {
        return $this->_gratuityCampaignManager->tagAsNotified($id);
    }
}
