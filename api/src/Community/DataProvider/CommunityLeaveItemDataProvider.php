 ...
 *
 */
final class CommunityLeaveItemDataProvider implements ItemDataProviderInterface, RestrictedDataProviderInterface
{
    protected $request;
    ...
    {
        return Community::class === $resourceClass && $operationName === "leave";
    }
    ...
    public function getItem(string $resourceClass, $id, string $operationName = null, array $context = [])
    {
        ...
        return $this->communityManager->leaveCommunity($id, $this->security->getUser());
    }
}
