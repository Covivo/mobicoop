...
/**
 * Collection data provider used to send a campaign to communityUsers.
 *
 * @author Sylvain Briat <sylvain.briat@mobicoop.org>
 * @author Remi Wortemann <remi.wortemann@mobicoop.org>
 */
final class CommunityUserCampaignSendCollectionDataProvider implements CollectionDataProviderInterface, RestrictedDataProviderInterface
{
    ...
    {
        return CommunityUser::class === $resourceClass && 'ADMIN_send_campaign' === $operationName;
    }
