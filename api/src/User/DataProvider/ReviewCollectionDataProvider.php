 ...
 */
final class ReviewCollectionDataProvider implements CollectionDataProviderInterface, RestrictedDataProviderInterface
{
    private $security;
    ...
    public function getCollection(string $resourceClass, string $operationName = null): iterable
    {
        ...
        return $this->reviewManager->getReviews($this->security->getUser());
    }
}
