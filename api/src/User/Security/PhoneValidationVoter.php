...
class PhoneValidationVoter extends Voter
{
    ...
    {
        switch ($attribute) {
            case self::PHONE_VALIDATION_VALIDATION:
                return $this->canValidatePhoneNumber();
        }

        throw new \LogicException('This code should not be reached!');
    }

    private function canValidatePhoneNumber()
    {
        return $this->authManager->isAuthorized(self::PHONE_VALIDATION_VALIDATION);
    }
}
