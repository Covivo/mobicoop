...
/**
 * Event sent when an identity proof is reminder is triggered.
 */
class IdentityProofValidationReminderEvent extends Event
{
    public const NAME = 'identity_proof_validation_reminder';
