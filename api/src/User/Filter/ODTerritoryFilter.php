...
final class ODTerritoryFilter extends AbstractContextAwareFilter
{
    ...
    public function getDescription(string $resourceClass): array
    {
        ...
        foreach ($this->properties as $property => $strategy) {
            $description["{$property}"] = [
                ...
                'required' => false,
                'swagger' => [
                    'description' => 'Filter on users that have an orifin or a destination in the given territory',
                    'name' => 'oDTerritory',
                    'type' => 'integer',
                ],
            ];
