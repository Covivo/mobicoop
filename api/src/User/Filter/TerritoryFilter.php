...
final class TerritoryFilter extends AbstractContextAwareFilter
{
    protected function filterProperty(string $property, $value, QueryBuilder $queryBuilder, QueryNameGeneratorInterface $queryNameGenerator, string $resourceClass, string $operationName = null)
    {
        ...
        $queryBuilder
            ...
            ->andWhere(sprintf('(territory.id = %s AND (ST_INTERSECTS(territory.geoJsonDetail,dd.geoJsonDetail)=1 OR ST_INTERSECTS(territory.geoJsonDetail,dp.geoJsonDetail)=1 OR (ST_INTERSECTS(territory.geoJsonDetail,homeAddress.geoJson)=1 AND homeAddress.home=1)))', $value));
    }
