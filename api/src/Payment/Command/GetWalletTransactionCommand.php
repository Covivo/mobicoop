...
class GetWalletTransactionCommand extends Command
{
    ...
    {
        return $this->_TransactionManager->getLastMonthWalletTransactions($this->_paymentAccountantWalletId);
    }
}
