 ...
 */
final class PaymentPaymentItemDataProvider implements ItemDataProviderInterface, RestrictedDataProviderInterface
{
    ...
    {
        return $this->paymentManager->buildPaymentPaymentFromCarpoolPayment($id);
    }
}
