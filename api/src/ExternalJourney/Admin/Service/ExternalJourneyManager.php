...
use App\ExternalJourney\Service\ExternalJourneyManager as ServiceExternalJourneyManager;
...
class ExternalJourneyManager
{
    ...
    public function __construct(ServiceExternalJourneyManager $externalJourneyManager)
    {
    ...
    {
        return $this->externalJourneyManager->getExternalJourneys($request, $params);
    }
}
