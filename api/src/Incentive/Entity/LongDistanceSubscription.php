...
class LongDistanceSubscription
{
     ...
     * @var string
     *
     * @ORM\Column(type="string", length=255, options={"comment": "The autogenerated initial commintment proof"})
     */
     ...
     * @var string
     *
     * @ORM\Column(type="string", length=255, options={"comment": "The autogenerated honour certificate"})
     */
