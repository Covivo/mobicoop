...
class LongDistanceSubscription
{
     ...
     *
     * @param LongDistanceJourney $commitmentProofJourney the autogenerated initial commintment proof
     */
    public function setCommitmentProofJourney(?LongDistanceJourney $commitmentProofJourney): self
    {
        ...
        $this->addLongDistanceJourney($this->getCommitmentProofJourney());
