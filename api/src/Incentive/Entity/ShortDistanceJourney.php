...
class ShortDistanceJourney extends Journey
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="\App\Incentive\Entity\ShortDistanceSubscription", inversedBy="shortDistanceJourneys", cascade={"persist"})
     */
     ...
     *
     * @ORM\OneToOne(targetEntity=CarpoolProof::class, inversedBy="mobConnectShortDistanceJourney", cascade={"persist"})
     *
