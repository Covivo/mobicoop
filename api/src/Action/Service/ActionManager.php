...
class ActionManager
{
    ...
    public function onAction(ActionEvent $actionEvent)
    {
        ...
        if ($actionEvent->getAction()->isInLog()) {
            ...
            if (!is_null($actionEvent->getPtProvider())) {
                $log->setPtProvider($actionEvent->getPtProvider());
                $log->setPtProviderThresholdReached($actionEvent->isPtProviderThresholdReached());
            }
