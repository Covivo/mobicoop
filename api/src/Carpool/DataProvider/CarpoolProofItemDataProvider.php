...
/**
 * Item data provider for Carpool proof.
 */
final class CarpoolProofItemDataProvider implements RestrictedDataProviderInterface, ItemDataProviderInterface
{
    protected $adManager;
    protected $request;
    ...
    {
        return $this->adManager->getCarpoolProof($this->request->get("id"));
    }
}
