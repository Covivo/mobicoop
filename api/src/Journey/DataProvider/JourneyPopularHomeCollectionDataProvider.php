 ...
 *
 */
final class JourneyPopularHomeCollectionDataProvider implements CollectionDataProviderInterface, RestrictedDataProviderInterface
{
    ...
    {
        return Journey::class === $resourceClass && $operationName === "popularHome";
    }
    
    public function getCollection(string $resourceClass, string $operationName = null): ?array
    {
        return $this->journeyManager->getPopularJourneysForHome();
    }
}
