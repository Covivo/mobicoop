...
/**
 * Data persister for Solidary volunteers in administration context.
 */
final class SolidaryVolunteerDataPersister implements ContextAwareDataPersisterInterface
{
    ...
    public function __construct(RequestStack $requestStack, SolidaryVolunteerManager $solidaryVolunteerManager)
    {
    ...
    {
        if ($data instanceof SolidaryVolunteer) {
            switch ($context) {
    ...
    public function persist($data, array $context = [])
    {
        if (isset($context['item_operation_name']) && 'ADMIN_patch' == $context['item_operation_name']) {
            ...
            $data = $this->solidaryVolunteerManager->patchSolidaryVolunteer($this->request->get('id'), json_decode($this->request->getContent(), true));
        }
    ...
    public function remove($data, array $context = [])
    {
        ...
        //     return $this->solidaryVolunteerManager->deleteSolidaryVolunteer($data);
        // }
    }
}
