...
/**
 * Event sent when a volunteer status is changed within a structure.
 * The attached SolidaryUserStructure handles all the needed informations !
 *
 * @author Sylvain Briat <sylvain.briat@mobicoop.org>
 */
class VolunteerStatusChangedEvent extends Event
{
    public const NAME = 'volunteer_status_changed';
