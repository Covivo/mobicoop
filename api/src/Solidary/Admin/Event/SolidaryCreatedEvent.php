...
{
    // we define name and action to avoir unwanted side effects as another event exists with the same action...
    public const NAME = 'solidary_created';
    public const ACTION = 'solidary_create';
