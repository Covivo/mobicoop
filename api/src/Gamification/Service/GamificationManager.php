...
class GamificationManager
{
    ...
    public function generateBadgeTwoRewards(User $user)
    {
        ...
        if ($nbAds >= 1) {
            $this->handleRetroactivelyRewards($user, 5);
        }
        return;
    }
