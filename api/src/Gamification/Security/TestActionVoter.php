...
class TestActionVoter extends Voter
{
    ...
    {
        switch ($attribute) {
            case self::GAMIFICATION_TEST_ACTION:
                return $this->canTestAction();
        }

        throw new \LogicException('This code should not be reached!');
    }

    private function canTestAction()
    {
        return $this->authManager->isAuthorized(self::GAMIFICATION_TEST_ACTION);
    }
}
