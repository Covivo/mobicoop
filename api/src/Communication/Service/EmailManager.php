...
class EmailManager
{
    ...
    public function send(Email $mail, $template, $context=[], $lang='fr_FR')
    {
        ...
        if ($this->emailAdditionalHeaders && isset($context['contact']) && !is_null($context['contact']) && !is_null($context['contact']->getContactType()) && $context['contact']->getContactType()->getObjectCode() == ContactType::TYPE_SUPPORT) {
