...
final class MangoPayHookKYCCollectionDataProvider implements CollectionDataProviderInterface, RestrictedDataProviderInterface
{
    ...
    {
        return MangoPayHook::class === $resourceClass && 'mangoPayKYC' == $operationName;
    }
    ...
    public function getCollection(string $resourceClass, string $operationName = null): iterable
    {
        ...
        if (
            MangoPayHook::VALIDATION_SUCCEEDED !== $this->request->get('EventType')
            && MangoPayHook::VALIDATION_FAILED !== $this->request->get('EventType')
            && MangoPayHook::VALIDATION_OUTDATED !== $this->request->get('EventType')
        ) {
