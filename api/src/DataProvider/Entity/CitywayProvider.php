...
class CitywayProvider implements ProviderInterface
{
    ...
    private function getCollectionTripPoints($class, array $params)
    {
        ...
        if (0 != $params['latitude'] && 0 != $params['longitude']) {
    ...
    private function deserializeLineStop($data)
    {
        ...
        if (isset($data['Line'], $data['Line']['Id'])) {
        ...
        if (isset($data['Stop'], $data['Stop']['Id'])) {
    ...
    private function deserializeSection($data, $num)
    {
        ...
        if (isset($data['Leg']) && !is_null($data['Leg'])) {
            $travelMode = null;
            if (self::CW_PT_MODE_WALK == $data['Leg']['TransportMode']) {
                // walk mode
                $travelMode = new TravelMode(TravelMode::TRAVEL_MODE_WALK);
                $leg->setTravelMode($travelMode);
            } elseif (self::CW_PT_MODE_BIKE == $data['Leg']['TransportMode']) {
                // bike mode
                $travelMode = new TravelMode(TravelMode::TRAVEL_MODE_BIKE);
                $leg->setTravelMode($travelMode);
            } elseif (self::CW_PT_MODE_CAR == $data['Leg']['TransportMode']) {
                // car mode
        ...
        if (isset($data['PTRide']) && !is_null($data['PTRide'])) {
            $travelMode = null;
            if (self::CW_PT_MODE_BUS == $data['PTRide']['TransportMode']) {
                // bus mode
                $travelMode = new TravelMode(TravelMode::TRAVEL_MODE_BUS);
                $leg->setTravelMode($travelMode);
            } elseif (self::CW_PT_MODE_TRAMWAY == $data['PTRide']['TransportMode']) {
                // tramway mode
                $travelMode = new TravelMode(TravelMode::TRAVEL_MODE_TRAMWAY);
                $leg->setTravelMode($travelMode);
            } elseif (self::CW_PT_MODE_COACH == $data['PTRide']['TransportMode']) {
                // coach mode
                $travelMode = new TravelMode(TravelMode::TRAVEL_MODE_COACH);
                $leg->setTravelMode($travelMode);
            } elseif (self::CW_PT_MODE_TRAIN == $data['PTRide']['TransportMode']) {
                // train local mode
                $travelMode = new TravelMode(TravelMode::TRAVEL_MODE_TRAIN);
                $leg->setTravelMode($travelMode);
            } elseif (self::CW_PT_MODE_TRAIN_LOCAL == $data['PTRide']['TransportMode']) {
                // train local mode
                $travelMode = new TravelMode(TravelMode::TRAVEL_MODE_TRAIN_LOCAL);
                $leg->setTravelMode($travelMode);
            } elseif (self::CW_PT_MODE_TRAIN_HIGH_SPEED == $data['PTRide']['TransportMode']) {
                // train high speed mode
                $travelMode = new TravelMode(TravelMode::TRAVEL_MODE_TRAIN_HIGH_SPEED);
                $leg->setTravelMode($travelMode);
            } elseif (self::CW_PT_MODE_ON_DEMAND == $data['PTRide']['TransportMode']) {
                // transport on demand
                $travelMode = new TravelMode(TravelMode::TRAVEL_MODE_ON_DEMAND);
                $leg->setTravelMode($travelMode);
            } elseif (self::CW_PT_MODE_METRO == $data['PTRide']['TransportMode']) {
                // Metro
                $travelMode = new TravelMode(TravelMode::TRAVEL_MODE_METRO);
                $leg->setTravelMode($travelMode);
            } elseif (self::CW_PT_MODE_TROLLEY_BUS == $data['PTRide']['TransportMode']) {
                // Trolley bus
