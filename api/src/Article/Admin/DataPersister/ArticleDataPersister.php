...
final class ArticleDataPersister implements ContextAwareDataPersisterInterface
{
    ...
    {
        return $data instanceof Article && ((isset($context['collection_operation_name']) &&  $context['collection_operation_name'] == 'ADMIN_post') || ((isset($context['item_operation_name']) && $context['item_operation_name'] == 'ADMIN_patch') || ((isset($context['item_operation_name']) && $context['item_operation_name'] == 'ADMIN_delete'))));
    }
