...
{
    public const CAMPAIGN_NAME = 'Campaign';
    public const CONTACT_EMAIL = 'EMAIL';
    public const CONTACT_FAMILYNAME = 'NOM';
    public const CONTACT_GIVENNAME = 'PRENOM';
    public const SIZE_LIMIT_CONTACT_IMPORT = 8388608;
    private $folderId;
    private $senderName;
    private $senderEmail;
    private $replyTo;
