...
class Address implements \JsonSerializable
{
     ...
     * @Groups({"arUser", "awUser", "read","readUser","results","write","writeRelayPoint","pt","mass","massCompute","threads","thread","readRelayPoint", "writeSolidary","readPayment"})
     */
    private $houseNumber;
     ...
     * @Groups({"arUser", "awUser", "read","readUser","results","write","writeRelayPoint","pt","mass","massCompute","readRelayPoint", "writeSolidary","readPayment"})
     ...
     *
     * @ORM\Column(type="string", length=255, nullable=true)
     * @Groups({"arUser", "awUser", "read","readUser","results","write","writeRelayPoint","pt","mass","massCompute","threads","thread","externalJourney","readRelayPoint", "writeSolidary", "readPayment", "writePayment"})
     */
     ...
     * @Groups({"arUser", "awUser", "read","readUser","results","write","writeRelayPoint","pt","mass","massCompute","externalJourney","readRelayPoint", "writeSolidary", "readPayment", "writePayment"})
     * @Assert\NotBlank(groups={"mass","massCompute","threads","thread"})
     */
    private $postalCode;
     ...
     * @Groups({"arUser", "awUser", "read","readUser","results","write","writeRelayPoint","pt","mass","massCompute","threads","thread","readRelayPoint", "writeSolidary"})
     */
    private $subLocality;
     ...
     *
     * @ORM\Column(type="string", length=100, nullable=true)
     * @Groups({"arUser", "awUser", "read","readUser","readEvent","results","write","writeRelayPoint","pt","mass","massCompute","threads","thread","externalJourney","readCommunity","readRelayPoint", "writeSolidary", "readPayment", "writePayment", "readExport"})
     * @Assert\NotBlank(groups={"mass","massCompute","threads","thread"})
     */
     ...
     *
     * @ORM\Column(type="string", length=100, nullable=true)
     * @Groups({"arUser", "awUser", "read","readUser","results","write","writeRelayPoint","pt","mass","massCompute","threads","thread","readRelayPoint", "writeSolidary", "writePayment"})
     */
    private $macroCounty;
     ...
     *
     * @ORM\Column(type="string", length=100, nullable=true)
     * @Groups({"arUser", "awUser", "read","readUser","results","write","writeRelayPoint","pt","mass","massCompute","threads","thread","readRelayPoint", "writeSolidary", "readPayment", "writePayment"})
     */
    private $region;
     ...
     *
     * @ORM\Column(type="string", length=100, nullable=true)
     * @Groups({"arUser", "awUser", "read","readUser","results","write","writeRelayPoint","pt","mass","massCompute","threads","thread","externalJourney","readRelayPoint", "writeSolidary", "writePayment"})
     */
     ...
     * @Groups({"arUser", "awUser", "read","readUser","readCommunity","readEvent","results","write","writeRelayPoint","pt","mass","massCompute","threads","thread","externalJourney","readRelayPoint", "writeSolidary"})
     */
    private $latitude;
     ...
     *
     * @ORM\Column(type="string", length=45, nullable=true)
     * @Groups({"arUser", "awUser", "read","readUser","results","write","writeRelayPoint"})
     */
    private $name;
     ...
     *
     * @Groups({"arUser", "awUser", "read","readUser","readCommunity","readEvent","results","pt","readRelayPoint", "readExport"})
     */
     ...
     *
     * @Groups({"arUser", "read","readRelayPoint"})
     */
    private $icon;
