...
describe('Share an ad - Driver - round trip - ponctual', () => {
  ...
  it('Connection mobicoop + Share an ad', () => {
    ...
    /* Driver */
    cy.get('#Vousêtes0 > .field > :nth-child(1) > .b-radio').contains('Conducteur')
      .click()
    ...
    /* Margin */
    cy.get(':nth-child(3) > .columns > .is-4 > .select > select')
    .select('5')
    ...
    /* Margin */
    cy.get(':nth-child(2) > .columns > .is-4 > .select > select')
    .select('5')
