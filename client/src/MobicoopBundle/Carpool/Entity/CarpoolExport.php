 ...
 */
class CarpoolExport implements ResourceInterface, \JsonSerializable
{
    ...
    /**
     * @var Address The pickUp point of the carpool
     */
    private $pickUp;

    /**
     * @var Address The dropOff point of the carpool
     */
    private $dropOff;
