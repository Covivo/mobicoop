...
import {messages_fr, messages_en} from "@translations/components/user/profile/Alert/";
import {messages_client_fr, messages_client_en} from "@clientTranslations/components/user/profile/Alert/";
