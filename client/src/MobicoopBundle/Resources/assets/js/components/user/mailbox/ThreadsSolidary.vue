...
import {messages_en, messages_fr} from "@translations/components/user/mailbox/ThreadsSolidary/";
import {messages_client_en, messages_client_fr} from "@clientTranslations/components/user/mailbox/ThreadsSolidary/";
