    ...
    public function userMessagesActionsInfos(Request $request, AskManager $askManager, AskHistoryManager $askHistoryManager, UserManager $userManager)
    {
        if ($request->isMethod('POST')) {
            ...
            if ($data['idAsk']) {
                ...
                $driver = true; // only for development purpose
                $passenger = true; // only for development purpose

                    // As a driver
                if ($driver) {
                    $response['driver'] = [
                            'contactAvatar'=>"http://localhost:8080/upload/users/images/versions/100-52cd1510b1c8946556b21d54978b1c-1.png",
                            'contactName'=>"Tenshi K.",
                            'requester'=>true, // The Ask requester
                            'carpooler'=>false,
                            'status' => 1, // Status of the Ask
                            'frequency' => 2, // 1 : puntucal, 2 : regular
                            'roundTrip' => false,
                            'distance' => "2500",
                            'rounded_price' => "2.50",
                            'seats' => '2',
                            'waypoints' => [
                                ...
                                "1" => [
                                    ...
                                    "role" => "passenger",
                                    "person" => "requester",
                                    "time" => "2019-11-01T12:20:00Z",
                                    "avatar" => "http://localhost:8080/upload/users/images/versions/100-13deaa87419b60fe336614da30e183-1.png"
                                ],
                                "2" => [
                                    "id" => 3,
                                    "address" => [
                                ...
                                "3" => [
                                    ...
                                    "role" => "driver",
                                    "person" => "",
                                    "time" => "2019-11-01T13:55:00Z",
                                    "avatar" => "http://localhost:8080/upload/users/images/versions/100-52cd1510b1c8946556b21d54978b1c-1.png"
                                ]
                            ],
                            'regular' => [
                                "type" => 1, // 1 = one way trip; 2 = outward of a round trip; 3 = return of a round trip (should not be returned !!!)
                                "fromDate" => "2019-11-01T13:55:00Z",
                                "maxDate" => "2020-02-01T13:55:00Z",
                                "maxDate" => "2020-02-01T13:55:00Z",
                                "days" => [
                                    "monCheck" => true,
                                    "tueCheck" => true,
                ...
                if ($passenger) {
                    $response['passenger'] = [ // As a passenger
                            'contactAvatar'=>"http://localhost:8080/upload/users/images/versions/100-52cd1510b1c8946556b21d54978b1c-1.png",
                            'contactName'=>"Tenshi K.",
                            'requester'=>true, // The Ask requester
                            'carpooler'=>false,
